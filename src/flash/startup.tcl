...
# apm32[e1x|f0xx|s1x] uses the same flash driver as the apm32f1x
proc apm32e1x args { eval apm32f1x $args }
proc apm32f0xx args { eval apm32f1x $args }
proc apm32s1x args { eval apm32f1x $args }
